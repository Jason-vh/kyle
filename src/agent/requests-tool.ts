...
const params = Type.Object({
  userId: Type.String({
    description: "The Slack user ID to look up requests for",
  }),
});
...
export const getRequestsForUserTool: AgentTool<typeof params> = {
  ...
  description:
    "Get all media add/remove requests made by a specific user. Returns a chronological list of actions (add, remove) with media titles and IDs.",
  parameters: params,
